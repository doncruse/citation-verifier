...
2. **Task 10's 117 gold-pair verdicts are mis-labeled.** They're stored at `opinion_window_chars=60000` but were scored at 20K. Future queries that filter by window will be misled. Either re-label to 20000 (loses cache-hit identity for any v1-fulltext follow-up) or re-run at actual 60K / full text and supersede.
