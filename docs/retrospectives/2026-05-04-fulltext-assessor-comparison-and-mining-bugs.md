...
- [ ] **Re-run v1.1 calibration at full text.** ~514 cells × 2 candidate models = ~1000 Sonnet + Haiku calls. Definitive answer to "can Sonnet replace Opus" at proper input.
- [ ] **Re-run gold-pair Opus at full text.** ~127 calls. Replace the mis-labeled Task 10 entries; gives us the canonical baseline at the right window.
