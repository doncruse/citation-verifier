...
| 20K char opinion truncation rarely hides supporting passages because supporting language usually appears in the syllabus / intro / holding (first quarter of opinion). May matter more for older opinions with frontmatter | If calibration study (v1.2) shows MAX_OPINION_CHARS sensitivity, raise it |
