...
- After short-form filter: 1016 (dropped 106)
- After foreign filter: 1016 (dropped 0)
- After dedup: 971 (removed 45)
- After K=5 cap per (citing_cluster, cited_tier): 600 (dropped 371)
- Stratified sample: 194 rows (target 200)
...
- State_IAC: 44/75 = 0.59 per opinion
